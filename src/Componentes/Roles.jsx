...
export const Roles = ({ handleLogout }) => {
    ...
    useEffect(() => {
        const savedUsers = JSON.parse(localStorage.getItem('users')) || [
            { name: 'Juan Pérez', email: 'juan.perez@ejemplo.com', role: 'Usuario', status: 'Activo' },
    ...
    const handleEditPermissions = (index) => {
        ...
        user.role = user.role === 'Usuario' ? 'Moderador' : user.role === 'Moderador' ? 'Administrador' : 'Usuario';
        setUsers(updatedUsers);
        setFilteredUsers(updatedUsers);
    };
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.mainContent}>
                ...
                {/* Descripción breve del apartado */}
...
const styles = {
    ...
    sidebar: {
        ...
        alignItems: 'center',
        padding: '20px 0', // Ajuste para que sea similar a la primera imagen
        color: '#FFF',
        boxShadow: '2px 0 12px rgba(0,0,0,0.1)',
    },
    profileCircle: {
        width: '80px', // Tamaño original de la imagen en la primera imagen
        height: '80px',
        borderRadius: '50%',
        backgroundColor: '#FFF',
        marginBottom: '20px',
    ...
    navIcon: {
        width: '24px', // Tamaño original de los íconos en la primera imagen
        height: '24px',
    },
    navItem: {
        fontWeight: '600',
